    ...
    div [ class "container" ]
        [ div [ class "field" ]
            ...
            , label [ class "checkbox-control" ]
                ...
                , p [ class "checkbox-message" ] [ text "Tick here to receive the latest news, offers and promotions from Kano. Take a peak at how we are using your data. Or see our terms and conditions." ]
                ]
            ]
        ]
