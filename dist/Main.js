...
var author$project$Main$createPostRequest = function (signup) {
	return elm$http$Http$post(
		{
			body: elm$http$Http$jsonBody(
				author$project$Main$signupEncoder(signup)),
			expect: elm$http$Http$expectString(author$project$Main$Submitted),
			url: '/api/signup'
		});
};
		...
		switch (msg.$) {
			...
			case 'ToggleNotifications':
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'Submit':
				var validated = author$project$Main$validateEmail(model);
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					function () {
						switch (validated.$) {
							case 'Null':
								return author$project$Main$createPostRequest(
									A2(author$project$Main$Signup, model.email, model.notifications));
							case 'ValidationOK':
								return author$project$Main$createPostRequest(
									A2(author$project$Main$Signup, model.email, model.notifications));
							default:
			...
			default:
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{error: 'Oops, there is an error, please try again later.'}),
						elm$core$Platform$Cmd$none);
				}
		}
	});
...
var author$project$Main$ToggleNotifications = {$: 'ToggleNotifications'};
...
var author$project$Main$viewValidation = function (model) {
	var _n0 = model.validationResults;
	switch (_n0.$) {
		case 'Null':
			return A2(
				elm$html$Html$p,
		...
		case 'Error':
			...
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text('Sorry, that email address isn\'t valid. Please try again.')
					]));
		default:
			return A2(
				elm$html$Html$p,
...
var author$project$Main$viewSignupContent = function (model) {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('newsletterSubmission')
							]),
						_List_fromArray(
							[
								A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												elm$html$Html$Attributes$name('campaign'),
												elm$html$Html$Attributes$value(flags.campaign)
											]),
										_List_Nil),
										A2(
										elm$html$Html$input,
										...
										_List_fromArray(
											[
												elm$html$Html$text(flags.button)
											]))
									]))
							])),
						function () {
						var _n0 = flags.checkbox;
						if (_n0) {
							return A2(
								elm$html$Html$div,
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('consent-checkbox')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												elm$html$Html$text('By ticking here you are opting-in to receive the latest news, offers, promotions and competitions from Kano. '),
												A2(
												elm$html$Html$a,
												_List_fromArray(
													[
												...
												_List_fromArray(
													[
														elm$html$Html$text('Take a peak ')
													])),
												elm$html$Html$text('at how we are using your data.')
											]))
									]));
						} else {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text(flags.description)
							]))
					]))
			]));
};
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Main$viewSignupContent(model)
							]))
					]))
			]));
};
												...
												return A2(
													...
													function (button) {
														return elm$json$Json$Decode$succeed(
															{button: button, campaign: campaign, checkbox: checkbox, description: description, title: title});
													},
													A2(elm$json$Json$Decode$field, 'button', elm$json$Json$Decode$string));
											},
											A2(elm$json$Json$Decode$field, 'campaign', elm$json$Json$Decode$string));
									},
									A2(elm$json$Json$Decode$field, 'checkbox', elm$json$Json$Decode$bool));
							},
