...
var author$project$MainTest$flagsTest = A2(
	...
	_List_fromArray(
		[
			...
			'init flags returns nothing',
			function (_n0) {
				var nothingFlags = elm$core$Maybe$Nothing;
				var _n1 = author$project$Main$init(nothingFlags);
				var initNothing = _n1.a;
				return A2(elm_explorations$test$Expect$equal, initNothing.flags, author$project$Main$initFlags);
			}),
			A2(
			elm_explorations$test$Test$test,
			'init returns custom flags',
			function (_n2) {
				var okFlags = A5(author$project$Main$Flags, 'star wars', 'kano', 'test', 'button', true);
...
var author$project$Test$Generated$Main1753917640$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/natasharamburrun/kano/elm-widget/tests/MainTest.elm']),
		processes: 4,
